...
def detect(self, images, verbose=0):
    ...
    if verbose:
        logging.log("Processing {} images".format(len(images)))
        for image in images:
            logging.log("image", image)
    ...
    if verbose:
        logging.log("molded_images", molded_images)
        logging.log("image_metas", image_metas)
        logging.log("anchors", anchors)
