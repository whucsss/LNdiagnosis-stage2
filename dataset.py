...
class ShapesDataset(Dataset):
    ...
    def load_shapes(self, count, img_floder, mask_floder, imglist, yaml_floder):
        self.add_class("shapes", 1, "lymph_normal")
        self.add_class("shapes", 2, "lymph_abnormal")
    ...
    def load_mask(self, image_id):
        ...
        for i in range(len(labels)):
            if labels[i].find("lymph_normal") != -1:
                labels_form.append("lymph_normal")
            elif labels[i].find("lymph_abnormal") != -1:
                labels_form.append("lymph_abnormal")
