...
if __name__ == "__main__":
    ...
    dataset_root_path = "./train_dataset_new/"
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint(
            os.path.join(MODEL_DIR, "stage2" + datetime + "_epoch{epoch:03d}_loss{loss:.3f}_val_loss{val_loss:.3f}.h5"),
    ...
    if True:
        ...
        # 使用的优化器是
        # optimizer = keras.optimizers.SGD(lr=learning_rate, momentum=config.LEARNING_MOMENTUM,
